...
four_comparisons_1 = baseline['Portfolio']
four_comparisons_1.name = 'Baseline'

#10 Combinations of indicator[1] + 5c3
for combo in itertools.combinations(range(2, 7), 3):
    combo += (1,)
    ...
    four_comparisons_1 = pd.concat([four_comparisons_1, port], axis=1)
...
print(four_comparisons_1)
name = '/Users/Stephen/Desktop/FML/Four_Indicator_1_Results.csv'
four_comparisons_1.to_csv(name, index=True)


four_comparisons_2 = baseline['Portfolio']
four_comparisons_2.name = 'Baseline'

#4 Combinations of indicator[2] + 4c3
for combo in itertools.combinations(range(3, 7), 3):
    combo += (2,)
    # Construct, train, and store a Q-learning trader.
    env.train_learner( start = args.train_start, end = args.train_end,
                       symbol = args.symbol, trips = args.trips, dyna = args.dyna,
    ...
    for c in combo:
        ...
        combo_name += " & "
    port.name = combo_name[:-3]
    four_comparisons_2 = pd.concat([four_comparisons_2, port], axis=1)

    # Out of sample.  Only do this once you are fully satisfied with the in sample performance!
    #env.test_learner( start = args.test_start, end = args.test_end, symbol = args.symbol 

print(four_comparisons_2)
name = '/Users/Stephen/Desktop/FML/Four_Indicator_2_Results.csv'
four_comparisons_2.to_csv(name, index=True)


four_comparisons_3 = baseline['Portfolio']
four_comparisons_3.name = 'Baseline'
...
for c in combo:
    ...
    combo_name += " & "
port.name = combo_name[:-3]
four_comparisons_3 = pd.concat([four_comparisons_3, port], axis=1)

# Out of sample.  Only do this once you are fully satisfied with the in sample performance!
#env.test_learner( start = args.test_start, end = args.test_end, symbol = args.symbol 

print(four_comparisons_3)
name = '/Users/Stephen/Desktop/FML/Four_Indicator_3_Results.csv'
four_comparisons_3.to_csv(name, index=True)