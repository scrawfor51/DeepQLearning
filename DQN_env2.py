...
three_comparisons_1 = baseline['Portfolio']
three_comparisons_1.name = 'Baseline'
...
for combo in itertools.combinations(range(2, 7), 2):
    ...
    three_comparisons_1 = pd.concat([three_comparisons_1, port], axis=1)
...
print(three_comparisons_1)
name = '/Users/Stephen/Desktop/FML/Three_Indicator_1_Results.csv'
three_comparisons_1.to_csv(name, index=True)


three_comparisons_2 = baseline['Portfolio']
three_comparisons_2.name = 'Baseline'
...
for combo in itertools.combinations(range(3, 7), 2):
    ...
    for c in combo:
        ...
        combo_name += " & "
    port.name = combo_name[:-3]
    three_comparisons_2 = pd.concat([three_comparisons_2, port], axis=1)

    # Out of sample.  Only do this once you are fully satisfied with the in sample performance!
    #env.test_learner( start = args.test_start, end = args.test_end, symbol = args.symbol 

print(three_comparisons_2)
name = '/Users/Stephen/Desktop/FML/Three_Indicator_2_Results.csv'
three_comparisons_2.to_csv(name, index=True)


three_comparisons_4 = baseline['Portfolio']
three_comparisons_4.name = 'Baseline'
...
for c in combo:
    ...
    combo_name += " & "
port.name = combo_name[:-3]
three_comparisons_4 = pd.concat([three_comparisons_4, port], axis=1)

# Out of sample.  Only do this once you are fully satisfied with the in sample performance!
#env.test_learner( start = args.test_start, end = args.test_end, symbol = args.symbol 

print(three_comparisons_4)
name = '/Users/Stephen/Desktop/FML/Three_Indicator_4_Results.csv'
three_comparisons_4.to_csv(name, index=True)