...
four_comparisons_0 = baseline['Portfolio']
four_comparisons_0.name = 'Baseline'

#20 Combinations of indicator[0] + 6c3
for combo in itertools.combinations(range(1, 7), 3):
    ...
    four_comparisons_0 = pd.concat([four_comparisons_0, port], axis=1)
...
print(four_comparisons_0)
name = '/Users/Stephen/Desktop/FML/Four_Indicator_0_Results.csv'
four_comparisons_0.to_csv(name, index=True)
