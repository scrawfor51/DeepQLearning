...
five_comparisons_0 = baseline['Portfolio']
five_comparisons_0.name = 'Baseline'

#15 Combinations of indicator[0] + 6c4
for combo in itertools.combinations(range(1, 7), 4):
    combo += (0,)
    ...
    five_comparisons_0 = pd.concat([five_comparisons_0, port], axis=1)
...
print(five_comparisons_0)
name = '/Users/Stephen/Desktop/FML/Five_Indicator_0_Results.csv'
five_comparisons_0.to_csv(name, index=True)
