...
five_comparisons_1 = baseline['Portfolio']
five_comparisons_1.name = 'Baseline'

#5 Combinations of indicator[1] + 5c4
for combo in itertools.combinations(range(2, 7), 4):
    combo += (1,)
    ...
    five_comparisons_1 = pd.concat([five_comparisons_1, port], axis=1)
...
print(five_comparisons_1)
name = '/Users/Stephen/Desktop/FML/Five_Indicator_1_Results.csv'
five_comparisons_1.to_csv(name, index=True)


five_comparisons_2 = baseline['Portfolio']
five_comparisons_2.name = 'Baseline'

#1 Combinations of indicator[2] + 4c4
combo = (2,3,4,5,6)
# Construct, train, and store a Q-learning trader.
env.train_learner( start = args.train_start, end = args.train_end,
                   symbol = args.symbol, trips = args.trips, dyna = args.dyna,
...
for c in combo:
    ...
    combo_name += " & "
port.name = combo_name[:-3]
five_comparisons_2 = pd.concat([five_comparisons_2, port], axis=1)

# Out of sample.  Only do this once you are fully satisfied with the in sample performance!
#env.test_learner( start = args.test_start, end = args.test_end, symbol = args.symbol 

print(five_comparisons_2)
name = '/Users/Stephen/Desktop/FML/Five_Indicator_2_Results.csv'
five_comparisons_2.to_csv(name, index=True)


six_comparisons = baseline['Portfolio']
six_comparisons.name = 'Baseline'

#7 Combinations of 7c6
...
#Last combinations of all 7 indicators
combo = (0,1,2,3,4,5,6)
